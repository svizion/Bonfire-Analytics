  ...
  <fieldset>
    <legend>Google analytics API <em style="color: #aaa;font-weight:normal;">must be defined to use on site reports</em></legend>
		...
		<div class="control-group <?php echo form_has_error('ga_username') ? 'error' : ''; ?>">
			...
			<div class='controls'>
				<input id="ga_username" type="text" name="ga_username" maxlength="100" value="<?php echo isset($settings['ga_username']) ? $settings['ga_username'] : set_value('ga_username' , ''); ?>" />
		...
		<div class="control-group <?php echo form_has_error('ga_new_password') ? 'error' : ''; ?>">
			...
			<div class='controls'>
				<input id="ga_password" type="hidden" name="ga_password" value="<?php echo isset($settings['ga_password']) ? $settings['ga_password'] : set_value('ga_password' , ''); ?>" />
			...
			<div class='controls'>
				<input id="ga_code" type="text" name="ga_code" maxlength="100" value="<?php echo isset($settings['ga_code']) ? $settings['ga_code'] : set_value('ga_code' , ''); ?>" />
		...
		<div class="control-group <?php echo form_has_error('ga_enabled') ? 'error' : ''; ?>">
			...
			<div class='controls'>
				<?php echo form_dropdown('ga_enabled', array('0'=>'No','1'=>'Yes'), $settings['ga_enabled'], 'id="ga_enabled" class="span2"'); ?>
