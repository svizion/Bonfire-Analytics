...
class reports extends Admin_Controller
{
	 ...
	 * loads settings and language file
	 */
	 ...
	 * @param	object	$view		View to load for chart data if referrers is set
	 * @param	String	$noresults	View to load for chart data if referrers is not set
	 */
	private function cache($filename, $view, $noresults = 'empty_data')
	{
		...
		$cache = count($data['referrers']) ?
			$this->load->view('reports/chart_data/' . $view, $data, TRUE) :
			$this->load->view('reports/chart_data/' . $noresults, null, TRUE);
